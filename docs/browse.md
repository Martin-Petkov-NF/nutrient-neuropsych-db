...
24 entries. Do not edit this file by hand; it is rebuilt from the data.
...
| 24 | A pilot reported low deficiency rates in bariatric patients using vitamin patches, but it had no comparison group so it cannot answer whether patches work. | mixed | ungraded | ⚠️ **not yet read** | [2022](https://pubmed.ncbi.nlm.nih.gov/35859973/), cross sectional |
