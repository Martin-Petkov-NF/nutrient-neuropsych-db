# Corrections to the figures circulating in the source material

19 September 2026. Running log. Every entry is a claim that appeared in the material behind this request and did not survive being traced to its source.

This file exists because the brief asked for exactly this. It recorded that an earlier draft was poorly sourced, instructed that everything be double-checked, and named several source types it would not accept. The corrections matter more than the table itself, because they show the table was built by checking rather than by rephrasing.

Each entry gives the claim as circulated, what the primary source actually says, and why the difference matters.

---

## 1. Folate insufficiency affects about 20% of US adults
...
"Insufficiency" there means red blood cell folate below 748 nmol/L. That threshold is a **neural tube defect risk** threshold for women who might become pregnant. It has no established relationship to mental health and was never intended to mark one.

Actual folate deficiency, the thing that does have recognized neuropsychiatric consequences, was **under 1%** of persons aged 3 and over in every NHANES cycle across the whole period.

**Why it matters.** The claim is the single load-bearing number in the case for putting folate in a psychiatric differential. Corrected, the case largely collapses: the common finding is a pregnancy-related risk marker, and the condition with neuropsychiatric consequences is rare. The brief suspected this and asked for honest references. This is the honest answer, and it arrived from the citation the brief supplied.

One more detail worth passing on. The paper contains no discussion of neuropsychiatric outcomes at all. It is about preventing birth defects.

**Status.** Verified against the full text, 19 September 2026.

---

## 2. The B12 reference on subclinical deficiency in older adults
...
## 3. The "most common subclinical deficiencies" list is a list of intake shortfalls, and it traces to the supplement industry
...
The lead author's affiliation, printed on the paper, is the Department of Scientific and Regulatory Affairs at the **Council for Responsible Nutrition**, which is the dietary supplement industry's trade association. The paper's stated conclusion is that multivitamin and mineral supplements may serve as a practical means to increase micronutrient status.

And the paper measures **usual dietary intake against the estimated average requirement**. Not blood levels. Not deficiency. Its own reported figures are vitamin A 35%, vitamin C 31%, vitamin D 74%, vitamin E 67%, calcium 39% and magnesium 46% below the estimated average requirement, counting food and supplements together.

**Why it matters.** Three separate problems stack here, and each one alone would disqualify the list for this purpose.

An intake below an estimated average requirement is not a deficiency. The estimated average requirement is the intake that meets the needs of half of a healthy population by definition, so a substantial share of people falling below it is the expected arithmetic result, not a finding. It says nothing about any individual's biochemical status and nothing at all about symptoms.

The numbers were produced to make the case for supplementation, by the trade association for supplement manufacturers. That does not make them wrong, and the underlying NHANES intake data is real. It does mean that a course teaching clinicians to be skeptical of the evidence base cannot cite them through a chain that ends at a trade body, particularly when the brief has already ruled out supplement vendors as sources.

The chain also passes through the Linus Pauling Institute, which the brief specifically flags for double-checking. That was right to.

**The practical consequence for the table.** Magnesium, calcium, vitamin E, potassium and vitamin C cannot enter the table on these figures. Where a real biochemical prevalence exists it will be used instead. Where none exists the cell will say so.

**Status.** Citation, author affiliation and reported figures verified directly against the paper record, 19 September 2026.

---

## 4. Vitamin E: 80% to 88% of adults not getting enough

**As circulated.** National surveys indicate that upward of 80% to 88% of adults fail to consume enough vitamin E through diet alone.
...
There is a second reason vitamin E does not belong in this table regardless. Frank vitamin E deficiency in US adults is essentially confined to fat malabsorption states and a rare inherited ataxia, and its presentation is neurological rather than psychiatric.

**Status.** Intake figure verified through the paper record. Biochemical figure taken from the CDC report and its accompanying journal article, cited below.

---

## 5. Magnesium: roughly half the population deficient

**As circulated.** Roughly 45% to 50% of the US population falls short of the recommended dietary intake, "leading to low cellular reserves without obvious red flags on basic blood panels". A newer figure putting 67.8% of US adults in magnesium deficiency is now entering circulation and will reach this material soon.

**What the sources say.** The 45% to 50% is intake below the estimated average requirement, from the same supplement-industry paper. It is 46% counting supplements. It is not a measurement of anyone's magnesium status.
...
The same paper also states that serum has limited diagnostic value for detecting magnesium deficiency, and then uses serum to estimate that two thirds of adults are at risk.

**Why it matters.** None of this means the analyses are wrong. It means a clinician-facing table that printed "67.8% of US adults are magnesium deficient" would be repeating an industry-funded redefinition of deficiency as though it were a measurement. That is the exact mechanism the brief asked to be guarded against, and this figure is new enough that it will arrive in the source material shortly.

**Status.** All three citations verified against PubMed, 19 September 2026, including the author overlap.

---

## 6. Potassium and vitamin C at 30% to 46%, presenting as fatigue

**As circulated.** Roughly 30% to 46% of adults have inadequate potassium and vitamin C intakes, "which can present vaguely as persistent fatigue or marginal immune function".

**What the sources say.** These are two different nutrients with two different problems and they should never have been combined in one line.
...
On fatigue as a symptom, a caution that applies well beyond vitamin C. Fatigue overlaps with the diagnostic criteria for depression. That overlap is a reason to be careful about attributing fatigue to a nutrient, not a reason to count fatigue as a psychiatric symptom and thereby qualify the nutrient for the table.

**Status.** Both vitamin C citations verified against PubMed, 19 September 2026.

---

## 7. The premise of the list, tested against the federal biochemical data
...
One incidental finding from the same paper belongs in the table: young women aged 20 to 39 had median urinary iodine concentrations bordering on insufficiency.

For a further external check, the Dietary Guidelines for Americans 2020-2025 name four dietary components of public health concern for underconsumption in the general population: calcium, potassium, dietary fiber and vitamin D. Magnesium, vitamin E, vitamin C, zinc, copper and iodine are not on that list. The two nutrients that are on it are there on intake grounds, which is a statement about the food supply and long-term chronic disease risk rather than about measurable deficiency states.

**Status.** Citation verified against PubMed, 19 September 2026.

---

## 8. Up to 40% to 42% of US adults are vitamin D deficient
...
On standardized data the correct figures are **about 22% below 50 nmol/L in 2021 to 2023**, down from about 28% in 2001 to 2002, and **5.0% below 30 nmol/L**, which is the band the Institute of Medicine calls at risk of deficiency.

**Why it matters.** The gap between 41.6% and 22% is an assay artifact, not a change in the population. Anything published before about 2016, or citing pre-2007 survey data, is likely to carry the inflated figure forward. The rule worth carrying: treat any vitamin D prevalence above about 25% at the 20 ng/mL cutoff as an assay artifact until shown otherwise.

**A second correction sits alongside it.** The brief describes a disagreement between the Institute of Medicine and the Endocrine Society over whether the threshold is 20 or 30 ng/mL. That describes 2011. The Endocrine Society's 2024 guideline sets **no** threshold for deficiency, insufficiency or sufficiency, and advises against routine testing in healthy people. The 30 ng/mL target has no current guideline sponsor.

**Status.** All citations verified against PubMed, 19 September 2026.

---

## 9. Up to 24% of reproductive-age women have subclinical iron deficiency

**As circulated.** Up to 24% of reproductive-age women have depleted tissue stores with normal hemoglobin.
...
## 10. Subclinical B6 deficiency is highly prevalent in women on oral contraceptives

**As circulated.** Subclinical B6 deficiency is highly prevalent in women, particularly those taking oral contraceptives, which degrade and deplete B vitamins in the liver. Consequences given as severe premenstrual dysphoric disorder, mood swings, irritability and a lower threshold for anxiety.
...
**A related note.** B6 for premenstrual symptoms is a separate question and the answer is more favorable, though hedged. The effect direction is consistent across trials at 50 to 100 mg daily, and the reviewers' own verdict, reached independently 26 years apart, is that the methodology is poor, no trial justified its sample size, and only 1 of 31 trials rates at low risk of bias.

**Status.** All citations verified against PubMed, 19 September 2026.

---

## 11. Nearly 98% of Americans are below the optimal omega-3 threshold
...
## 12. Subclinical B12 insufficiency at 10% to 15% of US adults
...
And the sex claim runs the wrong way. Women had **better** functional B12 status than men on the combined indicator, and the group with low serum B12 but a normal functional marker was disproportionately younger women, which the survey authors say may have falsely reflected low B12.

**Status.** Citations verified against PubMed, 19 September 2026.

---

## 13. About 44% of the population does not meet daily calcium requirements
...
## Two claims from the wider list
...
- Roughly 50% of adult women not getting enough magnesium.
- Subclinical B6 deficiency highly prevalent in women taking oral contraceptives.
- Nearly 98% of Americans below the optimal omega-3 threshold, with an average Omega-3 Index around 4%.
- Transdermal vitamin D, B complex and magnesium as a route for people with impaired digestion.
- Dairy, tea and coffee blocking iron absorption, and calcium interfering with iron in multivitamins and prenatal supplements.

A note on the general shape of these. Several are dietary intake figures below an estimated average requirement rather than measured biochemical deficiency, and the two are being used interchangeably in the source material. Where that is the case the entry will say so, because it is the same category error as the folate one and it recurs throughout.
